...
output "chalkbot_resources_bucket_name" {
  value = aws_s3_bucket.chalkbot_resources.id
}

output "chalkbot_resources_bucket_arn" {
  value = aws_s3_bucket.chalkbot_resources.arn
}

output "connect_whitelist_key" {
  value = aws_s3_object.connect_whitelist.id
}

output "gpt_settings_key" {
  value = aws_s3_object.gpt_settings.id
}
